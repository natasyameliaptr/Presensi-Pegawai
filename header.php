...
<h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
  <a href="">
    <img src="<?= base_url() ?>/assets/img/logo2.png" alt="Tabler" class="navbar-brand-image" style="width: 80px; height: auto;">
  </a>
</h1>
                ...
                <div class="dropdown-menu">
                  <div class="dropdown-menu-columns">
                    <div class="dropdown-menu-column">
                      ...
                      <a class="dropdown-item" href="<?= base_url('admin/data_timelapse/jam_kerja.php') ?>">
                        Jam Kerja
                      </a>
                    </div>
                  </div>
